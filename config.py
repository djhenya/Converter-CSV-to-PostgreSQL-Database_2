...
Настройки для подключения к БД:
    ...
    'primary_keys_for_tables': 'str: перечисление желаемых первичных ключей в виде списка строк. Пример: ["The number of enforcement proceeding", "The number of executive document", "Date of the institution of proceeding"]',
